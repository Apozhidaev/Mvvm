...
namespace Mvvm.Commands
{
    ...
    public class DelegateCommand<T> : DelegateCommandBase
    {
        ...
        public DelegateCommand(Action<T> executeMethod, Func<T, bool> canExecuteMethod,
            ...
            : base(o => executeMethod((T) o), o => canExecuteMethod((T) o), isAutomaticRequeryDisabled)
        {
        ...
        public static DelegateCommand<T> FromAsyncHandler(Func<T, Task> executeMethod, Func<T, bool> canExecuteMethod,
            bool isAutomaticRequeryDisabled = false)
        {
            return new DelegateCommand<T>(executeMethod, canExecuteMethod, isAutomaticRequeryDisabled);
        }
    ...
    public class DelegateCommand : DelegateCommandBase
    {
        ...
        public static DelegateCommand FromAsyncHandler(Func<Task> executeMethod, Func<bool> canExecuteMethod,
            bool isAutomaticRequeryDisabled = false)
        {
            return new DelegateCommand(executeMethod, canExecuteMethod, isAutomaticRequeryDisabled);
        }
